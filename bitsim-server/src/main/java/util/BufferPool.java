...
public class BufferPool {
    ...
    private static final String MAX_BUFFER_POOL_SIZE = "mqtt.maxBufferPoolSize";// 直接缓冲区池上限大小
    private static final String MIN_BUFFER_POOL_SIZE = "mqtt.minBufferPoolSize";// 直接缓冲区池下限大小
    private static final String WRITE_BUFFER = "mqtt.writeBuffer";
